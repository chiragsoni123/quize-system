    ...
    <div class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-sm">
        ...
        <form action="/user-signup" method="post" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" placeholder="Enter User Name" name="name" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                @error('name')
                    <div class="text-red-500">{{$message}}</div>
                @enderror
            </div>
            ...
            <div>
                ...
                <input type="password" placeholder="Confirm User Password" name="password_confirmation" class="w-full px-4 py-2 border border-gray-300 rounded-xl focus:outline-none">
                
            </div>
            <button type="submit" class="w-full bg-blue-500 rounded-xl px-4 py-2 cursor-pointer text-white">Signup</button>
        </form>
    </div>
</div> 
</body>
